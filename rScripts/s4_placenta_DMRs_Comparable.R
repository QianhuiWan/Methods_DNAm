...
save(bumphunter, ProbeLasso, DMRcate,
     file = here("Method_DNAme/rds/DMRmethods_ComparablePara.RData"))
# 
# mbm <- microbenchmark(
...
load(file = here("Method_DNAme/rds/DMRmethods_ComparablePara.RData"))
...
table(abs(ProbeLassoComp$betaAv_Second-ProbeLassoComp$betaAv_First) >0.2)
...
ProbeLassoComp <- ProbeLassoComp %>% 
  plyranges::filter(abs(ProbeLassoComp$betaAv_Second-ProbeLassoComp$betaAv_First) >0.2)
...
save(bumphunterComp, ProbeLassoComp, DMRcateComp, 
     file = here("Method_DNAme/rds/DMRmethods_ComparablePara_Grange.RData"))
